				...
				'https://api.groq.com/openai/v1/chat/completions',
				{
					...
					body: JSON.stringify({
						...
						messages: [
							{
								role: 'user',
								content: `Generate ${formData.aiAmount} flashcard topic-items to learn about: "${formData.aiTopic}". Return only the quoted items in a comma separated array, no other text. Items should be in same language as the given topic. Items should be just short words or phrases, not sentences, not questions (questions will be generated by AI later from these items).`,
							},
						],
					}),
				}
